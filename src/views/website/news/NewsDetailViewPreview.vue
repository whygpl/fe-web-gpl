            ...
            <div class="container mx-auto">
                ...
                <div class="mt-8 grid grid-cols-1 gap-4 md:grid-cols-6 md:gap-8 md:divide-x-2 md:divide-slate-400/50">
                    ...
                    <div class="h-full md:col-span-4 mr-8">
                        ...
                        <div class="gal-items text-justify md:text-left"><div v-dompurify-html="getLocale == 'EN' ? description_en : description"></div></div>
...
export default {
    ...
    methods: {
        ...
        getData (id) {
			this.$store.dispatch('news/getById', {id:id, status:'preview'}).then(data => {
            ...
            // ],
                this.breadcrumbs = [
                    { name_en: 'News & Article', name: 'Berita & Artikel', link: '/news' },
                    { name_en: 'Activity', name: 'Artikel', link: '/' },
