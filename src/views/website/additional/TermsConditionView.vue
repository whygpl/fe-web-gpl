            ...
            <div class="container mx-auto">
                <div class="gal-title-2 uppercase">
                    <div class="ql-editor" style="padding: 0;">
                        <div v-html="getLocale == 'EN' ? TermCondition.page_en : TermCondition.pages" />
                    </div>
                </div>
                <div class="mt-2 rounded bg-white px-4 py-6 md:mt-6 md:rounded-lg md:p-20">
                    <div class="grid grid-cols-1 gap-y-6 md:gap-y-8">
                        <div v-for="item in TermCondition.contact">
                            <div class="ql-editor" style="padding: 0;height: 28px;height:initial;">
                            ...
                            <template v-for="item_desc in item.description">
                                ...
                                <ul class="gal-items ml-8 list-disc">
                                    <li v-for="item_list in item_desc.list">
                                        <div class="ql-editor" style="padding: 0;height:initial;overflow-y:initial">
                                            <div v-html="getLocale == 'EN' ? item_list.name_en : item_list.name" />
                                        </div>
                                    </li>
    ...
    methods: {
        getData () {
            if (localStorage.getItem('termslive')) {
                this.TermCondition = JSON.parse(localStorage.getItem('termslive'))
