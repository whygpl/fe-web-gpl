        ...
        <section class="relative z-10 bg-gal-grey-light px-2 pb-10 pt-20 font-roboto before:absolute before:left-0 before:top-0 before:z-[-1] before:block before:h-72 before:w-full before:bg-primary before:content-[''] md:px-0 md:pt-32 md:before:h-80 lg:before:h-96">
            <div class="container mx-auto">
                <div class="ql-editor" style="padding: 0;">
                    <div class="gal-title-2 uppercase" v-html="getLocale == 'EN' ? faq.page_en : faq.pages" />
                </div>
                <div class="mt-2 flex flex-col flex-wrap gap-y-2 md:mt-6 md:flex-row md:gap-y-0">
                    <section class="flex basis-1/2 flex-col gap-y-2 px-0 md:gap-y-4 md:px-4">
                        <div v-for="item in list_first_column">
                            <div class="collapse collapse-arrow rounded bg-base-200 ql-editor" style="padding:0px">
                                <input type="checkbox" /> 
                                 <div  class="collapse-title bg-gal-grey text-base font-medium" v-html="getLocale == 'EN' ? item.question_en : item.question" />
                                <div class="collapse-content bg-white"> 
                                    <div class="ql-editor" style="padding: 0; ">
                                    <div  class="mx-0 mb-0 mt-4 text-base font-[400] md:mx-4 md:mb-2 md:mt-6" v-html="getLocale == 'EN' ? item.answer_en : item.answer" />
                                     </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="ql-editor" style="padding: 0;">
                    <div class="textxs font-roboto font-[400] italic text-gal-grey-darker md:text-sm" v-html="getLocale == 'EN' ? faq.title_en : faq.title" />
                </div>
            </div>
        </section>
        <Footer/>
