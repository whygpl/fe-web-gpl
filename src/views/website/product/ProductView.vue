                            ...
                            <div class="lg:pr-10">
                                ...
                                <div class="w-full font-roboto lg:w-1/2">
                                    ...
                                    <div
                                        ...
                                        <div class="text-left mr-0 md:mr-14" style="padding: 0; overflow-y: unset;">
                                            <div v-html="getLocale == 'EN' ? item.description_en : item.description">
                                            </div>
                                        </div>
                                    </div>

                                    <div v-if="item.router == 'ProductTypeHealthView'">
                                    ...
                                    <div v-if="item.router == 'ProductTypeDrugView'">
                                        <BpomCard :index="1" />
                                    </div>
...
import BpomCard from '@/components/card/BpomCard.vue';
import { mapState } from 'vuex'

export default {
    name: 'product',
    components: {
        Navbar, Footer, FlyingButton, BpomCard
    },
    data() {
        return {
            renderall: false,
